...
| `docs/save-results.md` | Save / reload session contract (JSON schema, reload flow, regression-guard matrix) |
| `docs/interaction-logging.md` | Replay-ready event log contract |
